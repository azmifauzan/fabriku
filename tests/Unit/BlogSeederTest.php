...
it('seeds 19 published blog posts across 4 categories with tags', function () {
    $this->seed(BlogSeeder::class);

    expect(BlogPost::count())->toBe(19);
    expect(BlogPost::where('status', 'published')->count())->toBe(19);
