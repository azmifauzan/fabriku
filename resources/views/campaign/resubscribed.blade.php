...
<head>
    ...
    <title>Berhasil Berlangganan Kembali — Fabriku</title>
...
<body>
    <div class="card">
        ...
        <h1>Berlangganan Kembali Berhasil!</h1>
        <p>
            Akun Anda telah diaktifkan kembali untuk menerima tips mingguan dan pembaruan fitur Fabriku.
        </p>
        ...
        <a href="/login" class="btn-primary">
            Masuk ke Dashboard Fabriku
        </a>

        <div class="footer-link">
            <a href="/">← Halaman Utama Fabriku</a>
        </div>
    </div>
</body>
</html>
