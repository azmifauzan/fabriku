        ...
        <div v-if="isScanning" class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
            <div class="w-full max-w-2xl rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800">
                ...
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <button type="button" @click="stopScanning" class="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
                ...
                <!-- Scanner Area -->
                <div class="relative overflow-hidden rounded-lg bg-black" style="min-height: 400px">
                    <div id="qr-reader" class="w-full"></div>
                </div>

                <!-- Status Message -->
                <div v-if="statusMessage" class="mt-4 rounded p-3" :class="statusClass">
                    {{ statusMessage }}
                </div>
