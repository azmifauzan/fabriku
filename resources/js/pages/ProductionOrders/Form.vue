          ...
          <div class="p-6 bg-white border-b border-gray-200">
            ...
            <form @submit.prevent="submit" class="space-y-6">
              ...
              <div class="bg-gray-50 p-4 rounded-lg">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Hasil {{ preparationLabel }}</h3>
                <div class="grid grid-cols-1 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      :class="{ 'border-red-500': form.errors.cutting_result_id, 'bg-gray-100': isEditing }"
                    >
                  ...
                  <!-- Cutting Result Info -->
                  <div v-if="selectedCuttingResult" class="bg-blue-50 p-4 rounded-md">
                    <div class="grid grid-cols-2 gap-4">
                      <div>
                        <p class="text-sm font-medium text-gray-700">{{ patternLabel }}</p>
                        <p class="text-sm text-gray-900">{{ selectedCuttingResult.cutting_order.pattern.name }}</p>
                        <p class="text-xs text-gray-500">{{ selectedCuttingResult.cutting_order.pattern.code }}</p>
                      </div>
                      <div>
                        <p class="text-sm font-medium text-gray-700">Good Pieces</p>
                        <p class="text-lg font-bold text-green-600">{{ selectedCuttingResult.actual_quantity - selectedCuttingResult.defect_quantity }} pcs</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="bg-gray-50 p-4 rounded-lg">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Detail Produksi</h3>
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    />
                    <p class="mt-1 text-xs text-gray-500">Tersedia: {{ availableQuantity }} pcs</p>
              ...
              <!-- Cost Estimation -->
              <div v-if="form.type === 'external' && selectedContractor && form.quantity_requested > 0" class="bg-yellow-50 p-4 rounded-lg">
                <h3 class="text-lg font-medium text-gray-900 mb-2">Estimasi Biaya</h3>
                <div class="grid grid-cols-2 gap-4">
                  <div>
                    <p class="text-sm text-gray-600">Tarif per Piece</p>
              ...
              <!-- Priority & Labor Cost -->
              <div class="bg-gray-50 p-4 rounded-lg">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Biaya & Prioritas</h3>
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                    <label class="block text-sm font-medium text-gray-700">
