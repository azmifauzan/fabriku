...
<template>
    <form @submit.prevent="submit" class="space-y-4">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
                <label class="block text-sm font-medium text-gray-700"> Quantity Diterima <span class="text-red-500">*</span> </label>
                <input
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700"> Tanggal Produksi <span class="text-red-500">*</span> </label>
                <input
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700"> Tanggal Diterima <span class="text-red-500">*</span> </label>
                <input
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div>
                ...
                <input
                    ...
                    min="0"
                    readonly
                    class="w-full rounded-lg border border-gray-300 bg-gray-100 px-4 py-2.5 text-sm shadow-sm transition-all focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-600 dark:text-gray-400"
        ...
        <div class="flex items-center justify-end gap-3">
            <button
                ...
                class="inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase hover:bg-indigo-700 disabled:opacity-50"
            >
